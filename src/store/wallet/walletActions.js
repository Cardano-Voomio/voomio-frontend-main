...
export function walletSolanaConnected(payload) {
  return {
    type: types.WALLET_SOLANA_CONNECTED,
    payload: payload
  };
}
...
export function walletSolanaDisconnected() {
  return {
    type: types.WALLET_SOLANA_DISCONNECTED
  };
}
