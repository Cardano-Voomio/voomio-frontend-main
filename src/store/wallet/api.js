...
import {
  ...
  walletSolanaConnected,
  walletCardanoDisconnected,
  walletSolanaDisconnected,
  setWalletLoading,
  setWalletData,
} from "./walletActions";
...
export const disconnectSolanaWallet = (provider, callback) => async (dispatch) => {
  console.log("disconnectSolanaWallet_provider::", provider);
  dispatch(walletSolanaDisconnected());
    callback({
      success: true,
    });
};
...
export const disconnectCardanoWallet = (provider, callback) => async (dispatch) => {
  console.log("disconnectCardanoWallet_provider::", provider);
  if (await Wallet.enable(provider)) {
    console.log("api_disconnectWallet_walletDisonnected___");
...
export const connectSolanaWallet = (provider, callback) => async (dispatch) => {
  dispatch(walletSolanaConnected(provider));
  callback({
    success: true,
    data: provider,
  });
...
export const connectCardanoWallet = (provider, callback) => async (dispatch) => {
  ...
  try {
    ...
    console.log("connectWallet_provider::", provider);
    if (await Wallet.enable(provider)) {
...
export const loadAssets = (wallet, callback) => async (dispatch) => {
  try {
    ...
    console.log('wallet_api_assets:', assets);
...
export const listToken =
  (wallet, asset, price, callback) => async (dispatch) => {
    try {
      ...
      console.log("[dream_log] listToken_(f)_walletUtoxs:", walletUtxos);
...
const getWalletAssets = async () => {
  ...
  console.log("[dream_log] getWalletAssets(f) utxos:", utxos);
  ...
  console.log("[dream_log] getWalletAssets(f) nativeAssets:", nativeAssets);
