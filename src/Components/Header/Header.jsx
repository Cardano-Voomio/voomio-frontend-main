...
import "./Header.css";
import SelectChainDropDown from "Components/SelectChainDropDown/SelectChainDropDown";

import {
    setChainState
} from "../../store/chain/api";

const Header = ({setChainType}) => {
    ...
    return (
        <>
            {/* Header */}
            <nav
                className={`header-container ${openMobilemenu
...
function mapDispatchToProps(dispatch) {
    return {
        setChainType: (chain_type, callback) =>
            dispatch(setChainState(chain_type, callback)),
    };
}
